...
export class FeedbackPage {
  ...
  details: any = '';
  temp: any = { "id_customer": "", "type": "", "message": "", "email": "", "mobile": '', "firstname": "", "lastname": "", "name": "" }

  constructor(public toast: ToastController, private commonService: CommonProvider, private loadingCtrl: LoadingController, public navCtrl: NavController, public navParams: NavParams,private events: Events) {
  ...
  send() {
    ...
    if (allow_submit) {
      if (this.temp['address'] != '' && this.temp['message'] != '' && this.temp['mobile'] != '' && this.temp['firstname'] != '' && this.temp['lastname'] != '' && this.temp['email'] != '' && this.temp['type'] != '') {
